...
button_clear = Button(root, text="Clear", padx=79, pady=20, command=button_cl)

button_sub = Button(root, text="-", padx=41, pady=20, command=button_su)
button_mul = Button(root, text="*", padx=40, pady=20, command=button_mu)
button_div = Button(root, text="/", padx=41, pady=20, command=button_di)
